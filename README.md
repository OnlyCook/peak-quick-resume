...
- If the game updates (version *number* increases), the map pool is (probably) also rotated which will make **all your save files load incorrect islands** (which may rarely cause everyone to fall through the map). This happens once every ~6 weeks.
