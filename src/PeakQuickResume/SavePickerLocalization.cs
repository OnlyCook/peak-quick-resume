    ...
    internal static class SavePickerLocalization
    {
        ...
        private static readonly Dictionary<PickerText, string[]> _table = new Dictionary<PickerText, string[]>
        {
            ...
            [PickerText.Star] = new[]
            {
                ...
                "Отметить", "Позначити", "收藏", "收藏", "お気に入り", "즐겨찾기", "Oznacz", "Yıldızla",
            },
            [PickerText.Unstar] = new[]
            {
                "Unstar", "Retirer", "Rimuovi", "Entmarkieren", "Desmarcar", "Desmarcar", "Desmarcar",
                "Убрать", "Прибрати", "取消收藏", "取消收藏", "解除", "해제", "Odznacz", "Kaldır",
            },
            ...
            [PickerText.Played] = new[]
            {
                ...
                "наиграно", "зіграно", "游玩时长", "遊玩時間", "プレイ時間", "플레이함", "rozegrane", "oynandı",
            },
            [PickerText.Tenderfoot] = new[]
            {
                "Tenderfoot", "Débutant", "Principiante", "Anfänger", "Novato", "Novato", "Novato",
                "Новичок", "Новачок", "新手", "新手", "初心者", "초보자", "Nowicjusz", "Acemi",
            },
